...
wget -q -O /usr/local/bin/ws-stunnel "https://raw.githubusercontent.com/Andyyuda/v5/main/tempek/ws-stunnel"
...
wget -q -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/Andyyuda/v5/main/tempek/newudpgw"
